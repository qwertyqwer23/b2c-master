	...
	public function return_data()
	{
		return [
			[
				...
				'COMMITDATE' => strtotime('1996-02-12'),
				'RECEIPTDATE' => strtotime('1996-03-22'),
			...
			[
				...
				'COMMITDATE' => strtotime('1996-02-28'),
				'RECEIPTDATE' => strtotime('1996-04-20'),
			...
			[
				...
				'COMMITDATE' => strtotime('1996-03-05'),
				'RECEIPTDATE' => strtotime('1996-01-31'),
				'SHIPINSTRUCT' => 'TAKE BACK RETURN',
				'SHIPMODE' => 'REG AIR',
			...
			[
				...
				'COMMITDATE' => strtotime('1996-03-30'),
				'RECEIPTDATE' => strtotime('1996-05-16'),
				'SHIPINSTRUCT' => 'NONE',
				'SHIPMODE' => 'AIR',
			...
			[
				...
				'COMMITDATE' => strtotime('1996-03-14'),
				'RECEIPTDATE' => strtotime('1996-04-01'),
				'SHIPINSTRUCT' => 'NONE',
				'SHIPMODE' => 'FOB',
